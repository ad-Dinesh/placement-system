          ...
          {RULES.map((rule) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={ok ? "text-gray-400" : "text-gray-600"}
                >
                  {rule.label}
                </span>
              </li>
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex animate-in fade-in duration-500">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-gradient-to-br from-gray-900 via-gray-950 to-violet-950/30 border-r border-white/10 p-12">
        ...
        {/* Content */}
        <div>
          <p className="text-5xl font-bold text-white leading-snug mb-6">
          ...
          <ul className="space-y-3 text-sm text-gray-500">
            ...
            {[
              "Apply to 10,000+ verified job listings",
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                autoComplete="name"
                className="w-full bg-gray-900 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-900 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-colors pr-10"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-violet-500 hover:bg-violet-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold py-2.5 rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-violet-500/25 mt-2"
            >
              {loading && (
                <Loader2
                  size={15}
